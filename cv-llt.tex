...
%% Photo is usually omitted in US academic CVs.
...
\leftheader{%
  {\LARGE\bfseries\sffamily Peng Liu, Ph.D.}

  \makefield{\faEnvelope[regular]}{\href{mailto:liupen@bc.edu}{\texttt{liupen@bc.edu}}}
\makefield{\faIcon{mobile}}{{\texttt{(857)-540-4818}}}
  \makefield{\faIcon{graduation-cap}}{\href{https://scholar.google.com/citations?user=7vzR4McAAAAJ&hl=en}{Google Scholar}}
  \makefield{\faIcon{globe}}{\href{https://pliu-ai.github.io}{pliu-ai.github.io}}
  \makefield{\faIcon{map-marker-alt}}
  {{\texttt{Boston, MA, USA}}}
  %en\makefield{\href{https://github.com/luckieucas}{\faGithubSquare}}    
